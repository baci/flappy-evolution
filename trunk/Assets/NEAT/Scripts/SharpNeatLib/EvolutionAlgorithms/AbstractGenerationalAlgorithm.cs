        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        public void StartContinue()
        {
            ...
            {   // Already running. Log a warning.
                Debug.Log("StartContinue() called but algorithm is already running.");
            }
            else
            {
        ...
        public void RequestPause()
        {
            if(RunState.Running == _runState) {
                ...
                Debug.Log("RequestPause() called but algorithm is not running.");
            }
        }
        ...
        public void RequestPauseAndWait()
        {
            ...
            {
				Debug.Log("RequestPauseAndWait() called but algorithm is not running.");
            }
        }
        ...
        private void OnUpdateEvent()
        {
            if(null != UpdateEvent)
            {
                ...
                try {
					...
					Debug.LogError("UpdateEvent listener threw exception" + ex.Message);
                }
            }
        }
        ...
        private void OnPausedEvent()
        {
            if(null != PausedEvent)
            {
                ...
                try {
					...
					Debug.LogError("PausedEvent listener threw exception" + ex.Message);
                }
            }
        }
