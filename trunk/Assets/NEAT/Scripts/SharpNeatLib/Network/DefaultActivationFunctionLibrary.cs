...
namespace SharpNeat.Network
{
    ...
    {
        public IList<ActivationFunctionInfo> _functionList;
        public Dictionary<int,IActivationFunction> _functionDict;
        public RouletteWheelLayout _rwl;
		...
		public DefaultActivationFunctionLibrary()
		{
        ...
        protected static Dictionary<int,IActivationFunction> CreateFunctionDictionary(IList<ActivationFunctionInfo> fnList)
        {
